...
|---|---|---|---|
| range (80% bands) | 280 | 94% inside | 80% |
| book (80% bands) | 7 | 57% inside | 80% |
| event size | 13 | median realized/typical 0.28; 100% beat ordinary | ~1.00; most |
| regime persistence | 95 | 52% correct | >50% |

*206 claims pending. Dates and sessions are approximations that grade against the registry, so this record understates rather than flatters.*
