...
|---|---|---|---|
| range (80% bands) | 240 | 93% inside | 80% |
| book (80% bands) | 6 | 50% inside | 80% |
| event size | 13 | median realized/typical 0.28; 100% beat ordinary | ~1.00; most |
| regime persistence | 82 | 50% correct | >50% |

*212 claims pending. Dates and sessions are approximations that grade against the registry, so this record understates rather than flatters.*
